...
public final class OrderServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.foodaid.Surplus.SurplusRequest,
      grpc.foodaid.Surplus.OrderAcknowledge> getSurplusRecordMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SurplusRecord",
      requestType = grpc.foodaid.Surplus.SurplusRequest.class,
      responseType = grpc.foodaid.Surplus.OrderAcknowledge.class,
  ...
  public static io.grpc.MethodDescriptor<grpc.foodaid.Surplus.SurplusRequest,
    ...
    if ((getSurplusRecordMethod = OrderServiceGrpc.getSurplusRecordMethod) == null) {
      synchronized (OrderServiceGrpc.class) {
        if ((getSurplusRecordMethod = OrderServiceGrpc.getSurplusRecordMethod) == null) {
          OrderServiceGrpc.getSurplusRecordMethod = getSurplusRecordMethod =
              io.grpc.MethodDescriptor.<grpc.foodaid.Surplus.SurplusRequest, grpc.foodaid.Surplus.OrderAcknowledge>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.foodaid.Surplus.OrderAcknowledge.getDefaultInstance()))
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                ...
                grpc.foodaid.Surplus.OrderAcknowledge>(
